...
public class ContactBrowser extends AbstractBoundWidget {
    ...
    // use a "BoundTable" with bitmasks for various options
    BoundTable contacts = new BoundTable(BoundTable.SCROLL_MASK +
            BoundTable.HEADER_MASK + BoundTable.NO_SELECT_CELL_MASK +
            BoundTable.NO_SELECT_COL_MASK + BoundTable.SORT_MASK, factory);
