 ...
 * @see com.totsp.gwittir.binding.BindingBuilder
 * @author <a href="mailto:cooper@screaming-penguin.com">Robert "kebernet"
 *         Cooper</a>
 */
public class Binding {
    private static final Logger LOGGER = Logger.getLogger("com.totsp.gwittir.client.introspection");
        ...
        if ((left != null) && (right != null)) {
            if (left.validator != null) {
                try {
                    ...
                    valid = false;
                    Binding.LOGGER.log(Level.WARNING, null, e);
                }
            }
    ...
    static class DefaultPropertyChangeListener implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Exception setting property: " + target.property.getName() + " on object "+target.object, e);
            }
        }
