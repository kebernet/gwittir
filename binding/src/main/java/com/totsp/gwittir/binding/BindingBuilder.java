 ...
 */
package com.totsp.gwittir.binding;

import com.google.gwt.event.dom.client.HasChangeHandlers;
import com.google.gwt.user.client.ui.SourcesChangeEvents;
import com.totsp.gwittir.binding.adapters.ChangeHandlerBindableAdapter;
import com.totsp.gwittir.binding.adapters.GWTBindableAdapter;
import com.totsp.gwittir.binding.adapters.OneWayBindingAdapter;
import com.totsp.gwittir.binding.interfaces.Finish;
import com.totsp.gwittir.binding.interfaces.SetBindingOptionsLeft;
import com.totsp.gwittir.binding.interfaces.SetBindingOptionsRight;
import com.totsp.gwittir.binding.interfaces.SetConverterRight;
import com.totsp.gwittir.binding.interfaces.SetLeft;
import com.totsp.gwittir.binding.interfaces.SetPropertyLeft;
import com.totsp.gwittir.binding.interfaces.SetPropertyRight;
import com.totsp.gwittir.binding.interfaces.SetRight;
import com.totsp.gwittir.binding.interfaces.SetValidateOrFinish;
import com.totsp.gwittir.binding.interfaces.SetValidateOrRight;
import com.totsp.gwittir.binding.interfaces.SetValidationFeedbackLeft;
import com.totsp.gwittir.binding.interfaces.SetValidationFeedbackRight;
import com.totsp.gwittir.binding.interfaces.SetValidatorRight;
import com.totsp.gwittir.binding.validator.CompositeValidationFeedback;
import com.totsp.gwittir.binding.validator.CompositeValidator;
...
public class BindingBuilder implements SetConverterRight, SetValidateOrFinish, SetLeft, SetBindingOptionsLeft, SetPropertyLeft, SetValidationFeedbackLeft,
    ...
    public Binding toBinding() {
        ...
        this.left.listener = new Binding.DefaultPropertyChangeListener(left, right);
        this.right.listener = new Binding.DefaultPropertyChangeListener(right, left);
