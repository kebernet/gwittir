...
import com.totsp.gwittir.binding.testmodel.Person;
import com.totsp.gwittir.binding.validator.IntegerValidator;
...
public class BindingGwtTest extends GWTTestCase {
    ...
    public void testBindingBuilder() throws Exception {
        ...
        b.setLeft();
        Assert.assertEquals(children1[0].getFirstName(), children1[1].getFirstName());
        b.bind();
        children1[0].setFirstName("Changed!");
        Assert.assertEquals("Changed!", children1[0].getFirstName());
        Assert.assertEquals("Changed!", children1[1].getFirstName());
        ...
        Assert.assertEquals(delaney.getFirstName().toUpperCase(), johnny.getFirstName());
        b.bind();
        delaney.setFirstName("Changed!");
        Assert.assertEquals("CHANGED!", johnny.getFirstName());
