...
public class ListSorter {
     ...
     */
    public static void sortOnProperty(List list, String propertyName, boolean ascending) throws Exception  {
        ...
        for(int i = 0; i < (list.size() - 1); i++) {
            for(int j = i + 1; j < list.size(); j++) {
                ...
                Comparable oc1 = (Comparable)p.getAccessMethod().invoke(o1, null);
                ...
                Comparable oc2 = (Comparable)p.getAccessMethod().invoke(o2, null);
