...
public class FlowTabPanel extends Composite {
    ...
    public FlowTabPanel(Widget managedWidget, FlowContext context) {
        ...
        table.addCell(0);
        table.getCellFormatter()
             .setStyleName(0, 1, GWITTIR_FLOW_TAB_PANEL_RIGHT);
    ...
    public void addTab(String activityName, Widget tabWidget, Object model) {
        ...
        if (right != 1) {
            ...
            table.getCellFormatter()
                 .setStyleName(0, right, GWITTIR_FLOW_TAB_PANEL_SPACER);
        ...
        table.insertCell(0, right);
        table.getCellFormatter()
             .setStyleName(0, right, GWITTIR_FLOW_TAB_PANEL_TAB);
    ...
    private void setActive(int cell) {
        for (int i = 0; i < table.getCellCount(0); i++) {
            if (table.getCellFormatter()
                         .getStyleName(0, i)
                         .equals(GWITTIR_FLOW_TAB_PANEL_TABACTIVE)) {
                table.getCellFormatter()
                     .setStyleName(0, i, GWITTIR_FLOW_TAB_PANEL_TAB);
            }
        }

        table.getCellFormatter()
             .setStyleName(0, cell, GWITTIR_FLOW_TAB_PANEL_TABACTIVE);
    }
}
