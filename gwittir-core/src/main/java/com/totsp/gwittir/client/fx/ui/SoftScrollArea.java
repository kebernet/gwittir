 ...
 * @author cooper
 */
public class SoftScrollArea extends Composite implements HasWidget, Introspectable, SourcesScrollEvents {
    ...
    public int getScrollPosition(){
        return this.scrollOverride == Integer.MIN_VALUE ? -1 * UnitsParser.parse( position.getTop() ).value : this.scrollOverride;
    }
    ...
    public void setScrollPosition(int position){
        ...
        this.listeners.fireScroll( this, this.getHorizontalScrollPosition(), this.getScrollPosition() );
    }
    ...
    public int getHorizontalScrollPosition(){
        return this.horizOverride == Integer.MIN_VALUE ? -1 * UnitsParser.parse( position.getLeft() ).value : this.horizOverride;
    }
    ...
    public void animateToScrollPosition( int newPosition, MutationStrategy integerStrategy, int duration ){
        ...
        this.scrollAnimator = new PropertyAnimator( this, "scrollPosition", new Integer(newPosition), integerStrategy, duration, new AnimationFinishedCallback(){
    ...
    public void animateToScrollPosition( int newPosition ){
        this.animateToScrollPosition( newPosition, MutationStrategy.INTEGER_SINOIDAL, this.getDefaultAnimationDuration() );
    }
    ...
    public void animateToHorizontalScrollPosition( int newPosition, MutationStrategy integerStrategy, int duration ){
        ...
        horizontalAnimator = new PropertyAnimator( this, "horizontalScrollPosition", new Integer(newPosition), integerStrategy, duration, new AnimationFinishedCallback(){
            public void onFinish(PropertyAnimator animator) {
    ...
    public void animateToHorizontalScrollPosition( int newPosition ){
        this.animateToHorizontalScrollPosition( newPosition, MutationStrategy.INTEGER_SINOIDAL, this.getDefaultAnimationDuration() );
    }
    ...
    public int getMaxScrollPosition(){
        int max = limit ? widget.getOffsetHeight() - base.getOffsetHeight() : Integer.MAX_VALUE;
        return max < 0 ? 0 : max;
    }
    
    public int getMaxHorizontalScrollPosition(){
        int max = limit ? widget.getOffsetWidth() - base.getOffsetWidth() : Integer.MAX_VALUE;
        return max < 0 ? 0 : max; 
    }
    ...
    private native int ensureVisibleHortizontalPosition( Element position, Element e) /*-{
        if (!e)
          return; 
