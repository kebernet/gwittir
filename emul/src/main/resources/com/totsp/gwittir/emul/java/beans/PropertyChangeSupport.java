...
public class PropertyChangeSupport implements Serializable {
    ...
    private HashMap<String, java.beans.PropertyChangeSupport> children = new HashMap<String, java.beans.PropertyChangeSupport>();
    ...
    public synchronized void removePropertyChangeListener(String propertyName,
        ...
        if ((propertyName != null) && (listener != null)) {
            java.beans.PropertyChangeSupport listeners = children.get(propertyName);
    ...
    public synchronized void addPropertyChangeListener(String propertyName,
        ...
        if ((listener != null) && (propertyName != null)) {
            ...
            if (listeners == null) {
                listeners = new java.beans.PropertyChangeSupport(source);
    ...
    public synchronized PropertyChangeListener[] getPropertyChangeListeners() {
        ...
        for (String propertyName : children.keySet()) {
            java.beans.PropertyChangeSupport namedListener = children
                    .get(propertyName);
