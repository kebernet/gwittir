...
package com.totsp.gwittir.emul.java.beans;
...
public class VetoableChangeSupport implements Serializable {
    ...
    private HashMap<String, java.beans.VetoableChangeSupport> children = new HashMap<String, java.beans.VetoableChangeSupport>();
    ...
    public synchronized void removeVetoableChangeListener(String propertyName,
        ...
        if ((propertyName != null) && (listener != null)) {
            java.beans.VetoableChangeSupport listeners = children.get(propertyName);
    ...
    public synchronized void addVetoableChangeListener(String propertyName,
        ...
        if (propertyName != null && listener != null) {
            ...
            if (listeners == null) {
                listeners = new java.beans.VetoableChangeSupport(source);
    ...
    public synchronized VetoableChangeListener[] getVetoableChangeListeners(
            String propertyName) {
        java.beans.VetoableChangeSupport listeners = null;
...
//    }
    ...
    private static VetoableChangeListener[] getAsVetoableChangeListenerArray(
            java.beans.VetoableChangeSupport listeners) {
